...
if __name__ == "__main__":
    ...
    for rho in [2.6,2.8]:
        ...
        plt.xlabel("Noise amplitude" +r"$(\eta)$",fontsize=labelFontSize)
        plt.xticks(fontsize=tickFontSize-2)
        plt.yticks(fontsize=tickFontSize-2)

        plt.xscale('log')
        
    plt.legend(loc='best', bbox_to_anchor=(0.45, 0.95),frameon=False,fontsize=tickFontSize-4
    ...
    plt.savefig(main_folder+"Noise_in_protein_kinetics"+".png",dpi=800)    
    plt.close()
